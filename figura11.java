...
public class figura11 extends figura
{
   public figura11(int nx1 , int ny1, int nx2, int ny2){
       super(nx1, ny1,nx2,ny2);
       super.ponDifx(nx1/3);
       super.ponDify(ny1/2);
       super.numeroFigura = 11;
    ...
    ponDifx( ancho / 2);
    	ponDify( altura /3 );
        c1.inicializar(nx1 + dameDifx()*2 , ny1,dameDifx(), dameDify());
