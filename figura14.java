...
/**
 * Write a description of class figura14 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class figura14 extends figura
{
     public  figura14( int nx1, int ny1, int nx2, int ny2 ) 
    {
     super( nx1, ny1, nx2, ny2 );
     super.ponDifx( nx2 / 2 );
     super.ponDify( ny2 / 3 );
     super.numeroFigura = 14;
    ...
    public void inicializar( int nx1, int ny1, int ancho, int altura )
    {
    	...
    	c3.inicializar( nx1 , ny1 + dameDify()    , dameDifx(), dameDify() );
