...
public class figura12 extends figura
{
   public figura12(int nx1, int ny1, int nx2, int ny2){
       super(nx1,ny1,nx2,ny2);
       super.ponDifx(nx1/2);
       super.ponDify(ny1/3);
       super.numeroFigura = 12;
       
       
       inicializar(nx1,ny1,nx2,ny2);
    }
   public void inicializar(int nx1, int ny1 , int ancho, int altura){
    ...
    c3.inicializar(nx1+ dameDifx(), ny1 + dameDify()*2, dameDifx(), dameDify());
