...
/**
 * Write a description of class figura15 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class figura15 extends figura
{

     public  figura15( int nx1, int ny1, int nx2, int ny2 ) 
    {
     super( nx1, ny1, nx2, ny2 );
     super.ponDifx( nx2 / 3 );
     super.ponDify( ny2 / 2 );
     super.numeroFigura = 15;
      ...
      public void inicializar( int nx1, int ny1, int ancho, int altura )
    {
    	...
    	c4.inicializar( nx1+ dameDifx() , ny1 + dameDify() , dameDifx(), dameDify() );    	    	    		
    }
