...
/**
 * Write a description of class figura16 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class figura16 extends figura
{
     public  figura16( int nx1, int ny1, int nx2, int ny2 ) 
    {
     super( nx1, ny1, nx2, ny2 );
     super.ponDifx( nx2 / 2);
     super.ponDify( ny2 / 3 );
     super.numeroFigura = 16;
      ...
      public void inicializar( int nx1, int ny1, int ancho, int altura )
    {
    	...
    	c2.inicializar( nx1        + dameDifx()     , ny1  + dameDify()   , dameDifx(), dameDify() );
    	c3.inicializar( nx1 + dameDifx()*2 , ny1 + dameDify()    , dameDifx(), dameDify() );
    	c4.inicializar( nx1 , ny1 + dameDify() * 2, dameDifx(), dameDify() );    	    	    		
    }
