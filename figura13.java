public class figura13 extends figura{
    
    public figura13( int nx1, int ny1, int nx2, int ny2 ) 
    {
     super( nx1, ny1, nx2, nx2 );
     super.ponDifx( nx2 / 3);
     super.ponDify( ny2 / 2);
     super.numeroFigura = 13;
    ...
    public void inicializar( int nx1, int ny1, int ancho, int altura )
    {
    	...
    	c4.inicializar( nx1 + dameDifx()*2, ny1 + dameDify() * 2, dameDifx(), dameDify() );    	    	    		
    }
