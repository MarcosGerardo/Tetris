// * @(#)figura7.java
public class figura8 extends figura 
{
    public figura8(int nx1 , int ny1 , int nx2 ,int ny2){
    
   super( nx1, ny1, nx2, nx2 );
     super.ponDifx( nx2 / 2);
     super.ponDify( ny2 / 3);
     super.numeroFigura = 8;
    ...
    public void inicializar(int nx1, int ny1, int ancho , int altura){
        ...
        c3.inicializar(nx1, ny1 + dameDify()*2 , dameDifx(), dameDify());
