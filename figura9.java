...
public class figura9 extends figura
{
   public figura9(int nx1 , int ny1, int nx2 , int ny2){
       super(nx1,ny1,nx2,ny2);
       super.ponDifx(nx2/3);
       super.ponDify(ny2/2);
       super.numeroFigura = 9;
    ...
    public void inicializar(int nx1 ,  int ny1 , int ancho , int altura){
        ...
        c3.inicializar(nx1 + dameDifx() , ny1, dameDifx(), dameDify());
        c4.inicializar(nx1 + dameDifx()*2 , ny1 , dameDifx(), dameDify());
